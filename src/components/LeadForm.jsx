  ...
  return (
    <section className="lead" id="audit">
      <div className="container lead__inner">
        <p className="section-label" style={{ textAlign: 'center' }}>Bezplatny audit</p>
        <h2 className="section-title lead__title">
          Pripravení na kontrolu<br />nad biznisom?
        </h2>
        <p className="lead__sub">
          Zanechajte nám kontakt a do 24 hodín s vami preberieme váš aktuálny stav.
        </p>
          ...
          <form className="lead__form" onSubmit={submit}>
            <div className="lead__row">
              <input
                ...
                placeholder="Vaše meno" required className="lead__input"
              />
              <input
                name="company" value={form.company} onChange={handle}
                placeholder="Názov firmy" className="lead__input"
              />
              <select
                name="type" value={form.type} onChange={handle}
                className="lead__input lead__select"
              >
            ...
            <div className="lead__row">
              <input
                ...
                placeholder="Email" required className="lead__input"
              />
              <input
                name="phone" type="tel" value={form.phone} onChange={handle}
                placeholder="Telefon" className="lead__input"
              />
            </div>
            ...
            <p className="lead__disclaimer">
              Bez záväzkov. Vaše údaje nezdieľame s tretími stranami.
            </p>
          </form>
        )}
      </div>
